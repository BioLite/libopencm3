 ...
 * @author @htmlonly &copy; @endhtmlonly 2024 Moyukh Chatterjee <moyukhc92@gmail.com>
 *
 * @brief This covers the "version 3" LPTIM peripheral.
 *
 * This LPTIM variant is used on the STM32G4, and likely more.
 * 
 */
/*
 * This file is part of the libopencm3 project.
 *
 * Copyright (C) 2024 Moyukh Chatterjee <moyukhc92@gmail.com>
 *
...
/* THIS FILE SHOULD NOT BE INCLUDED DIRECTLY, BUT ONLY VIA LPTIMER.H
The order of header inclusion is important. lptimer.h includes the device
